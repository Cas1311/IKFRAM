  ...
  <div class="transaction-filter">
    ...
    <div class="filter-row">
      ...
      <div class="filter-group">
        ...
        <input id="amountMin" type="number" v-model.number="localFilters.amountMin" placeholder="0" min="0" step="0.01"
          class="filter-input" />
      </div>

      <div class="filter-group">
        <label for="amountMax">Max Amount</label>
        <input id="amountMax" type="number" v-model.number="localFilters.amountMax" placeholder="No limit" min="0"
