...
export default {
  data() {
    return {
      friends: [
        { id: 'manuel', name: 'Manuel Lorenz', phone: '123-456-7890', email: 'manuel@localhost.com', isFavorite: true },
        { id: 'julie', name: 'Julie Jones', phone: '987-654-3210', email: 'julie@localhost.com', isFavorite: false },
      ],
    };
  },
  methods: {
